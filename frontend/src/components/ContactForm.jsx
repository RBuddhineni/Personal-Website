...
export default function ContactForm() {
  ...
  const socials = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/raghav-buddhineni/",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/RBuddhineni",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
      ...
      color: "#333",
      gradient: "linear-gradient(135deg, #24292e 0%, #4a5568 100%)"
    },
    {
      name: "Instagram",
      url: "https://www.instagram.com/raghavb_/",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
